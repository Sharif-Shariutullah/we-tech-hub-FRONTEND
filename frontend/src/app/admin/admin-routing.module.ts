...
import { JobPostEditComponent } from './components/Edit/job-post-edit/job-post-edit.component';
import { GlobalBpoEditComponent } from './components/Edit/global-bpo-edit/global-bpo-edit.component';
import { GalleryEditComponent } from './components/Edit/gallery-edit/gallery-edit.component';
import { NewsEditComponent } from './components/Edit/news-edit/news-edit.component';
import { CompletedListComponentComponent } from './components/list/careerlist/completed-list-component/completed-list-component.component';
...
const routes: Routes = [
  ...
  { path: 'galleryPost', component: PhotouploadComponent },
  ...
  { path: 'career-completed-list', component: CompletedListComponentComponent },

  { path: 'newsList', component: NewslistComponent },
  { path: 'serviceList', component: ServicelistComponent },
  { path: 'global-bpo-list', component: GlobalbpolistComponent },
  ...
  { path: 'career-edit/:id', component: JobPostEditComponent },
  { path: 'global-bpo-edit/:id', component: GlobalBpoEditComponent },
