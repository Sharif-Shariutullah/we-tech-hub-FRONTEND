...
@Component({
  selector: 'app-global-bpo-edit',
  templateUrl: './global-bpo-edit.component.html',
  styleUrls: ['./global-bpo-edit.component.scss'],
})
export class GlobalBpoEditComponent implements OnInit {
  ...
  private populateForm(data: globalBpoModel): void {
  ...
  UpdatePost() {
    ...
    this.bpoService.updateGlobalBPO(this.id, formData).subscribe(
      (response) => {
        console.log('Post updated successfully:', response);
        Swal.fire({
          icon: 'success',
          title: 'Done',
          text: 'GlobalBPO Updated Successfully',
      ...
      (error) => {
        ...
        console.error('Error updating GlobalBPO:', error);
      }
    );
  }
